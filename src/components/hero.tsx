  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6">
      <div className="max-w-4xl text-center">
        <h1 className="text-6xl md:text-8xl font-light text-gray-900 dark:text-white mb-8">
          Neal Anderson
        </h1>
        ...
        <p className="text-lg text-gray-500 dark:text-gray-500 mb-16 max-w-2xl mx-auto">
